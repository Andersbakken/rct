...
private:
    ...
    String *stringPtr() { return reinterpret_cast<String*>(mData.voidStar); }
    const String *stringPtr() const { return reinterpret_cast<const String*>(mData.voidStar); }
    Map<String, Value> *mapPtr() { return reinterpret_cast<Map<String, Value>*>(mData.voidStar); }
    const Map<String, Value> *mapPtr() const { return reinterpret_cast<const Map<String, Value>*>(mData.voidStar); }
    List<Value> *listPtr() { return reinterpret_cast<List<Value>*>(mData.voidStar); }
    const List<Value> *listPtr() const { return reinterpret_cast<const List<Value>*>(mData.voidStar); }
    std::shared_ptr<Custom> *customPtr() { return reinterpret_cast<std::shared_ptr<Custom>*>(mData.voidStar); }
    const std::shared_ptr<Custom> *customPtr() const { return reinterpret_cast<const std::shared_ptr<Custom>*>(mData.voidStar); }
