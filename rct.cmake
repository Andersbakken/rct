...
if (NOT CMAKE_SYSTEM_NAME MATCHES "Darwin")
  list(APPEND RCT_SYSTEM_LIBRARIES ${OPENSSL_CRYPTO_LIBRARY} pthread)
endif()

target_link_libraries(rct ${CORESERVICES_LIBRARY} ${COREFOUNDATION_LIBRARY} ${RCT_SYSTEM_LIBRARIES} ${ZLIB_LIBRARIES} ${V8_LIBS} ${DB_LIBS})
